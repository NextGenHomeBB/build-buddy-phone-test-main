-- Fix the handle_new_user function to work with our modified profiles table structure
-- The issue is that we made user_id nullable but the function still tries to use auth user IDs
